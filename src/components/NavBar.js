...
import footerLogoWhite from "../media/img/logo/MA-logos_white.png";
import footerLogoBlack from "../media/img/logo/MA-logos_black.png";
import NavBarLink from "./NavBarLink";

const NavBar = ({ info, about, work, repo, email, themeState, setThemeState }) => {
        ...
        <div className="xl:ml-56 navbar-start fadeleft2">
          <div tabIndex={0} className="">
            <div className="w-56 rounded-full">
              {/* <img width={50} height={50} src={navBarLogo} alt="MA logo" /> */}
              <div>{themeState === lightTheme ? <img className="w-2/4" src={footerLogoBlack} alt="logo black" /> : <img src={footerLogoWhite} className="w-2/4" alt="logo white" />}</div>
            </div>
          </div>
        </div>
        <NavBarLink info={info} about={about} work={work} repo={repo} email={email} />
        <div className="xl:mr-56 navbar-end fadeRight2">
